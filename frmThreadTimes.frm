...
Begin VB.Form frmThreadTimes 
   ...
   End
End
Attribute VB_Name = "frmThreadTimes"
...
Private Sub lstThread_Click()
    If Function_Exist("kernel32.dll", "OpenThread") = True Then
        ...
        If GetThreadTimes(hThread, ftCreation, ftExit, ftKernel, ftUser) = False Then Failed "GetThreadTimes"
