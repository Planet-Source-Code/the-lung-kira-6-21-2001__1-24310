...
Public Declare Function GetAdaptersInfo Lib "iphlpapi.dll" (ByRef pAdapterInfo As IP_ADAPTER_INFO, ByRef pOutBufLen As Long) As Long
...
Public Declare Function GetNetworkParams Lib "iphlpapi.dll" (ByRef pFixedInfo As FIXED_INFO, ByRef pOutBufLen As Long) As Long
